    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $share->post_id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $share->post_id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $share->id], ['confirm' => __('Are you sure you want to delete # {0}?', $share->post_id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
