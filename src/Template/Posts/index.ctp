...
<div class="posts">
  ...
  <div class="gallery">  
			...
			<div class="haut">
				...
				<?= $this->Paginator->sort('posted_at') ?>
                <?= h($post->posted_at) ?>
                
				<a href="<?= $this->Url->build(['controller' => 'Posts','action' => 'add']) ?>"><img src="https://images.unsplash.com/photo-1426604966848-d7adac402bff?w=500&h=500&fit=crop">
            </div>
...
echo $this->Form->textarea('comment', ['placeholder' => 'Add Comment','rows' => '2', 'cols' => '1']);
